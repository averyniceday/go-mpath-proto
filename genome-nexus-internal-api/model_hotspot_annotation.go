...
// checks if the HotspotAnnotation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HotspotAnnotation{}
...
func (o HotspotAnnotation) ToMap() (map[string]interface{}, error) {
