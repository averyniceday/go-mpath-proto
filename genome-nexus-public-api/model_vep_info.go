...
// checks if the VEPInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VEPInfo{}
...
func (o VEPInfo) ToMap() (map[string]interface{}, error) {
