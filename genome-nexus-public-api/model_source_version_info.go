...
// checks if the SourceVersionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceVersionInfo{}
...
func (o SourceVersionInfo) ToMap() (map[string]interface{}, error) {
